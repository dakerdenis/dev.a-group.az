...
class BackendMenu
{
    ...
    protected function getStructure(Request $request): array
    {
        return [
            ...
            ['title' => 'Sliders', 'icon' => 'fast-forward', 'route' => null, 'permissions' => ['edit sliders', 'create sliders'],  'children' => [
            ...
            ['title' => 'Roles & Permissions', 'icon' => 'user-check', 'route' => null, 'permissions' => ['edit roles', 'edit permissions'], 'children' => [
            ...
            ['title' => 'Staff', 'icon' => 'user-plus', 'route' => null, 'permissions' => ['edit roles', 'edit permissions'], 'children' => [
