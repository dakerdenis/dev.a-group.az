...
<meta property="og:image" content="{{$ogImage ?? asset('assets/img/azchemco_default_image_01.png')}}"/>
...
@endif
<meta name="twitter:image" content="{{$ogImage ?? asset('assets/img/azchemco_default_image_01.png')}}">
