            ...
            <div class="branch-list">
                @foreach($branches as $branch)
                    <div class="branch-block animate-on-scroll animate__animated" data-animation="fadeIn">
                        <a class="gallery" href="{{ $branch->getFirstMediaUrl('preview') }}" data-fancybox="gallery{{ $branch->id }}"><img width="225" height="225"
                                                                                                                 src="{{ $branch->getFirstMediaUrl('preview', 'thumbWebp') }}" alt="Image 1" loading="lazy">
                            <div class="over">
