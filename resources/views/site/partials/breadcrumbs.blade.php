        ...
        <section class="header">
            <div class="main-container animate-on-scroll animate__animated" data-animation="fadeIn">
                <div class="breadcrumbs">
                    <span><a title="{{__('site.homepage')}}" href="{{ route('index') }}">{{__('site.homepage')}}</a></span>
                    @foreach($breadcrumbs as $breadcrumb)
                        @if($loop->last)
            ...
            <picture class="p-abs-inset-0">
                <img class="img-in-picture" src="{{ $image->getUrl('webp') }}" width="2180" height="785" alt="{{ $page_title }}" loading="lazy">
            </picture>
        </section>
    @else
