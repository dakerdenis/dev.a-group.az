        ...
        <div class="form-container">
            ...
            <form action="{{ route('submit-product-form', [$model]) }}" id="contact-form">
                <div class="form-group">
                    <label for="fullName">{{ __('site.name') }}</label>
                    <input id="fullName" name="fullName" class="required" type="text">
                    <p style="display: none" class="error">{{ __('site.please_fill') }}</p>
                </div>
                <div class="form-group">
                    <label for="fullName">{{ __('site.last_name') }}</label>
                    <input id="fullName" name="fullName" class="required" type="text">
                    <p style="display: none" class="error">{{ __('site.please_fill') }}</p>
                </div>
                <div class="form-group">
                    <label for="fullName">{{ __('site.surname') }}</label>
                    <input id="fullName" name="fullName" class="required" type="text">
                    <p style="display: none" class="error">{{ __('site.please_fill') }}</p>
                </div>
                <div class="form-group">
                    <label for="fullName">{{ __('site.policy_number') }}</label>
                    <input id="fullName" name="fullName" class="required" type="text">
                    <p style="display: none" class="error">{{ __('site.please_fill') }}</p>
                </div>
                <div class="form-group">
                    <label for="fullName">{{ __('site.email') }}</label>
                    <input id="fullName" name="fullName" class="required" type="text">
                    <p style="display: none" class="error">{{ __('site.please_fill') }}</p>
                </div>
                <div class="form-group">
                    <label for="tel">{{ __('site.phone_number') }}</label>
                    <input id="tel" class="required" name="phone" type="tel">
                    <p style="display: none" class="error">{{ __('site.please_fill') }}</p>
                </div>
                <div class="form-group">
                    <label for="tel">{{ __('site.insurance_type') }}</label>
                    <select id="ts-year">
