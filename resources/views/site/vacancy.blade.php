            ...
            <div class="form-container">
                ...
                <form id="sendCV_form">
                    <div class="form-group">
                        <label for="fullname">{{ __('site.name_lastname') }}</label>
                        <input id="fullname" type="text">
                        <p class="error">Bölməni doldurun</p>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="tel">{{ __('site.phone') }}</label>
                        <input id="tel" type="tel">
                    </div>

                    <div class="form-group">
                        <label for="education">{{ __('site.education') }}</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file-input-wrapper">
                            ...
                            <label for="fileInput">
                                <input type="file" accept=".pdf,.doc,.docx" id="fileInput" onchange="updateFileInputText()">
                    ...
                    <div class="form-actions">
                        ...
                        <button class="submit" type="submit">{{ __('site.send') }}</button>
                    </div>
                </form>
            </div>
        </div>
