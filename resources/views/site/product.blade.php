...
<x-app-layout :class="$class">
    ...
    {{--            <img class="img-in-picture" src="media/images/cascocalc.jpeg" width="1666" height="2499" alt="" loading="lazy">--}}
    {{--        </picture>--}}
    {{--        <div class="main-container">--}}
    {{--            <h2 class="centralized animate-on-scroll animate__animated" data-animation="fadeIn">Калькулятор КАСКО</h2>--}}

    {{--            <div class="form-container">--}}
    {{--                <form>--}}
    {{--                    <div class="form-group horizontal">--}}
    {{--                        <label for="ts-category">Категория ТС</label>--}}
    {{--                        <div class="field">--}}
    {{--                            <select id="ts-category">--}}
    {{--                                <option value="" disabled selected>(не определен)</option>--}}
    ...
    {{--                    </div>--}}
    {{--                    <div class="form-group horizontal">--}}
    {{--                        <label for="ts-brand">Марка</label>--}}
    {{--                        <div class="field">--}}
    {{--                            <select id="ts-brand">--}}
    {{--                                <option value="" disabled>(не определен)</option>--}}
    {{--                                <option value="" selected>Mercedes-Benz</option>--}}
    {{--                                <option value="">2</option>--}}
    {{--                                <option value="">3</option>--}}
    {{--                            </select>--}}
    {{--                        </div>--}}
    {{--                    </div>--}}
    {{--                    <div class="form-group horizontal">--}}
    {{--                        <label for="ts-model">Модель</label>--}}
    {{--                        <div class="field">--}}
    {{--                            <select id="ts-model">--}}
    {{--                                <option value="" disabled>(не определен)</option>--}}
    {{--                                <option value="" selected>E63s AMG 4matic+</option>--}}
    {{--                                <option value="">2</option>--}}
    {{--                                <option value="">3</option>--}}
    {{--                            </select>--}}
    {{--                        </div>--}}
    {{--                    </div>--}}
    {{--                    <div class="form-group horizontal">--}}
    {{--                        <label for="ts-year">Год изготовления</label>--}}
    {{--                        <div class="field">--}}
    {{--                            <select id="ts-year">--}}
    {{--                                <option value="" disabled selected>(не определен)</option>--}}
    {{--                                <option value="">1</option>--}}
    ...
    {{--                    </div>--}}
    {{--                    <div class="form-group horizontal">--}}
    {{--                        <label for="ts-purpose">Цель использования</label>--}}
    {{--                        <div class="field">--}}
    {{--                            <select id="ts-purpose">--}}
    {{--                                <option value="" disabled selected>(не определен)</option>--}}
    {{--                                <option value="">1</option>--}}
    {{--                                <option value="">2</option>--}}
    {{--                                <option value="">3</option>--}}
    ...
    {{--                        </div>--}}
    {{--                    </div>--}}
    {{--                    <div class="form-group horizontal radio-inputs">--}}
    {{--                        <div></div>--}}
    {{--                        <div class="field">--}}
    {{--                            <div class="horizontal-radio-inputs">--}}
    {{--                                <label class="custom-radio-input" for="rent">--}}
    {{--                                    <input id="rent" type="radio" name="rent-attach" value="rent" checked>--}}
    {{--                                    <span class="radio-btn"><span></span></span>--}}
    {{--                                    Сдается в аренду--}}
    {{--                                </label>--}}
    {{--                                <label class="custom-radio-input" for="attach" >--}}
    {{--                                    <input id="attach" type="radio" name="rent-attach" value="attach">--}}
    {{--                                    <span class="radio-btn"><span></span></span>--}}
    {{--                                    Прицеп--}}
    {{--                                </label>--}}
    {{--                            </div>--}}
    ...
    {{--                    </div>--}}
    {{--                    <div class="form-group horizontal">--}}
    {{--                        <label for="ts-price">Стоимость ТС</label>--}}
    {{--                        <div class="field">--}}
    {{--                            <input id="ts-price" type="text" placeholder="(не определена)">--}}
    {{--                        </div>--}}
    {{--                    </div>--}}
    {{--                </form>--}}
    {{--            </div>--}}
            ...
            <div class="main-container">
                ...
                <div class="links">
                    @foreach($product->usefulLinks as $link)
                        <a href="{{ \Illuminate\Support\Str::startsWith('http', $link->link) ? $link->link : \Mcamara\LaravelLocalization\Facades\LaravelLocalization::getLocalizedURL(App::getLocale(), $link->link) }}"
