            ...
            <div class="form-container">
                ...
                <form action="{{ route('send-contact-form') }}" id="contact-form">
                    ...
                    <div class="form-group">
                        ...
                        <input name="company" id="company" class="required" type="text">
                        <p style="display: none" class="error">{{ __('site.please_fill') }}</p>
                    </div>

                    <div class="form-group">
                        <label for="email">{{ __('site.contacts_email_form') }}</label>
                        <input name="email" class="required" id="email" type="email">
                        <p style="display: none" class="error">{{ __('site.please_fill') }}</p>
                    </div>

                    <div class="form-group">
                        <label for="tel">{{ __('site.contacts_phone_form') }}</label>
                        <input id="tel" name="phone" class="required" type="tel">
                        <p style="display: none" class="error">{{ __('site.please_fill') }}</p>
                    </div>
