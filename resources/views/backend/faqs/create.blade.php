...
@section('content')
    ...
    @include('backend.partials.title_breadcrumbs', ['title' => isset($faqEntity) ? 'Update ' . $faqEntity->title : 'Create Faq', 'breadcrumbs' => [['active' => false, 'title' => 'Faqs', 'link' => route('backend.faq_entities.index')],], 'buttons' => null])
        <form
            action="{{isset($faqEntity) ? route('backend.faq_entities.update', $faqEntity) : route('backend.faq_entities.store')}}"
            method="post" enctype='multipart/form-data'>
        @method(isset($faqEntity) ? 'put' : 'post')
        @csrf
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                            ...
                                            @foreach(LaravelLocalization::getLocalesOrder() as $localeCode => $properties)
                                                <div class="tab-pane fade {{$loop->first ? 'active show' : ''}}"
                                                    ...
                                                    <div class="mb-0 m-t-30">
                                                        <div class="form-group">
                                                            ...
                                                            <input
                                                                ...
                                                                value="{{old('title:'.$localeCode, (isset($faqEntity) && $faqEntity->translate($localeCode)) ? $faqEntity->translate($localeCode)->title : '')}}"
                                                                id="title">
                                                    ...
                                                    <div class="form-group mt-3">
                                                        <label for="description:{{$localeCode}}"
                                                        ...
                                                        <textarea id="description:{{$localeCode}}"
                                                                  ...
                                                                  rows="3">{{old('description:'.$localeCode, (isset($faqEntity) && $faqEntity->translate($localeCode)) ? $faqEntity->translate($localeCode)->description : '')}}</textarea>
                                    ...
                                    <div class="card-footer">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body text-center switch-outline">
                                                        <label class="switch">
                                                            ...
                                                            <input type="checkbox" value="1" {{old('active') === "0" ? '' : (isset($faqEntity) && !$faqEntity->active ? '' : 'checked') }} data-original-title=""
                                        ...
                                        <button
                                            class="btn btn-primary">{{isset($faqEntity) ? 'Update' : 'Create'}}</button>
