        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12" id="repeatables">
                                    @foreach(old('repeatable') ?? (isset($block) && $block->repeatables ? $block->repeatables()->ordered()->get() : []) as $id => $repeatable)
                                        @include('backend.partials.card', ['id' => $id, 'repeatable' => $repeatable, 'media_collection_name' => 'preview'])
                                    @endforeach
                                </div>
                            </div>
                            <div class="row justify-content-center mb-3">
                                <div class="col-md-2 text-center">
                                    <button class="btn btn-outline-success" type="button" title=""
                                            ...
                                            data-type="simple"
                                            data-link="{{route('backend.blocks.add_card')}}"
                    ...
                    <div class="row mt-4">
                        <div id="delete_stat_info">

                        </div>
                        <h5 class="text-center mb-4">Extended statistic blocks</h5>
                        <div class="col-sm-12">
                            <div class="row">
                                <input type="hidden" name="data" value="">
                                <div class="col-sm-12" id="repeatables-s">
                                    @foreach(old('extended_stat') ?? (isset($block) && $block->extendedStats ? $block->extendedStats()->ordered()->get() : []) as $id => $repeatable)
                                        @include('backend.partials.stat', ['id' => $id, 'stat' => $repeatable])
                                    @endforeach
                                </div>
                            </div>
                            <div class="row justify-content-center mb-3">
                                <div class="col-md-2 text-center">
                                    <button class="btn btn-outline-success" type="button" title=""
                                            data-bs-original-title="btn btn-outline-success"
                                            data-type="simple"
                                            data-link="{{route('backend.blocks.add_extended_stat')}}"
                                            id="add_repeatable-s" data-original-title="btn btn-outline-success">
                                        Add
                                    </button>
                                </div>
                            </div>
