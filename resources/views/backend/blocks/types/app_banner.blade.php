                                        ...
                                        @foreach(LaravelLocalization::getLocalesOrder() as $localeCode => $properties)
                                            <div class="tab-pane fade {{$loop->first ? 'active show' : ''}}"
                                                ...
                                                <div class="mb-0 m-t-30">
                                                    ...
                                                    <div class="form-group mt-3">
                                                        <label for="data:{{$localeCode}}[link]" class="col-form-label">Link</label>
                                                        <input
                                                            class="form-control"
                                                            type="text" name="data:{{$localeCode}}[link]"
                                                            value="{{old('data:'.$localeCode.'.link', (isset($block) && $block->translate($localeCode)) ? $block->translate($localeCode)->data['link'] : '')}}"
                                                            id="data:{{$localeCode}}[link]">
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
