                                            ...
                                            <div class="tab-pane fade {{$loop->first ? 'active show' : ''}}"
                                                ...
                                                <div class="mb-0 m-t-30">
                                                    ...
                                                    <div class="form-group mt-3">
                                                        <label for="data:{{$localeCode}}[heading_description]"
                                                               class="col-form-label">Heading Description</label>
                                                        <textarea id="data:{{$localeCode}}[heading_description]"
                                                                  class="form-control"
                                                                  name="data:{{$localeCode}}[heading_description]{{$localeCode}}"
                                                                  cols="30"
                                                                  rows="6">{{old('data:'.$localeCode.'.heading_description', (isset($block) && $block->translate($localeCode) && $block->translate($localeCode)->data) ? $block->translate($localeCode)->data['heading_description'] : '')}}</textarea>
                                                    </div>
                                                    <div class="form-group mt-3">
