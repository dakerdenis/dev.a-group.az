...
@section('content')
    ...
    @include('backend.partials.title_breadcrumbs', ['title' => isset($department) ? 'Update ' . $department->title : 'Create Department', 'breadcrumbs' => [['active' => false, 'title' => 'Departments', 'link' => route('backend.departments.index')],], 'buttons' => null])
        <form
            action="{{isset($department) ? route('backend.departments.update', $department) : route('backend.departments.store')}}"
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                                    ...
                                                    <div class="mb-0 m-t-30">
                                                        <div class="form-group">
                                                            ...
                                                            <input
                                                                ...
                                                                value="{{old('title:'.$localeCode, (isset($department) && $department->translate($localeCode)) ? $department->translate($localeCode)->title : '')}}"
                                                                id="title">
                                    ...
                                    <div class="card-footer">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body text-center switch-outline">
                                                        <label class="switch">
                                                            ...
                                                            <input type="checkbox" value="1" {{old('active') === "0" ? '' : (isset($department) && !$department->active ? '' : 'checked') }} data-original-title=""
                                        ...
                                        <button
                                            class="btn btn-primary">{{isset($department) ? 'Update' : 'Create'}}</button>
